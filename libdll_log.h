...
static const size_t dlldbg_nested_depth_display_prefix_len =
    sizeof(dlldbg_nested_depth_display_prefix) - sizeof(char);
static const char   dlldbg_nested_depth_display[] = "--";
static const size_t dlldbg_nested_depth_display_len =
    sizeof(dlldbg_nested_depth_display) - sizeof(char);
static const char   dlldbg_nested_depth_display_postfix[] = "> ";
static const size_t dlldbg_nested_depth_display_postfix_len =
    sizeof(dlldbg_nested_depth_display_postfix) - sizeof(char);
...
static inline char * dlldbg_log_get_method_depth_arg(void) {
  ...
  const size_t depth_arg_written_len    = snprintf(depth_arg_buff,
                                                depth_arg_buff_len,
                                                "%s%s%s",
                                                dlldbg_nested_depth_display_prefix,
                                                depth_arg_display_buff,
                                                dlldbg_nested_depth_display_postfix);
...
static inline void dlldbg_depth_inc(void) { dlldbg_nested_depth += 1; }
static inline void dlldbg_depth_dec(void) {
  if (0 != dlldbg_nested_depth) {
    dlldbg_nested_depth -= 1;
  }
}
static inline void dlldbg_depth_set(size_t depth) { dlldbg_nested_depth = depth; }
static inline void dlldbg_depth_reset(void) { dlldbg_nested_depth = 0; }
...
static inline void dlldbg_atexit_clearance(void) {
  if (dlldbg_parent_filename) {
